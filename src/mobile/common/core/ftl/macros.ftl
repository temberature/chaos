...
-->
    <#if __debug__ && mockjax?size gt 0>
...
<#-- 非测试环境，且有实验室键，且不存在版本号 -->
    <#if !__debug__ && key?? && key!="" && (!version?? || version == "")>
...
<#macro docHead title="" keywords="" description="" css=[] namespace="" vml=false xFrame="" canonical="" agent=[] robots=false touchIcon="" clean=false webviewTitle="" meta={} metaList=[] bodyStyle="" bodyClass="" viewportContent="" googleExperimentKey="" useWebCache = true showItunesApp=true>
    ...
    <#if metaList?size == 0>
        <#local metaList = [{"property":"og:type", "content":"money"}, {"property":"og:title", "content":"立马理财"}, {"property":"og:url", "content":"https://www.lmlc.com/wap"}, {"property":"og:image", "content":"https://www.lmlc.com" + "../img/oglogo.png#url"}] />
    </#if>
    <@docHeadCore
    domain = sys_domain
    title = title
...
<#-- 测试后台数据代码 -->
    ...
    js = jsFileList + js
    delayJS = delayJS
    mockjaxLib = ["mockjax#url", "mockjax/mock#url"]
    mockjax = mockjax
    >
        <#nested><#t>
    </@docFootCore>
