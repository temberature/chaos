<#compress>
    ...
    <#include "core/components/form/weui-cell/main.ftl">
...
<#-- 通用的来源参数 -->
    ...
    <#assign RES_CSS_BASE_LIST = ['base/base.css#url']/>
    <#assign RES_CSS_CORE_LIST = ['core/core.css#url']/>
    <#assign RES_JS_BASE_LIST = ['base#url']/>
    <#assign RES_JS_CORE_LIST = ['core#url']/>
    <#assign RES_MOCK_BASE_LIST = ['mock/base.ajax.js#url']/>
